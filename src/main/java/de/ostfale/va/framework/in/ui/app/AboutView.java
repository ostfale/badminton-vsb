...
public class AboutView extends VerticalLayout {
    ...
    public AboutView(
            ...
            @Value("${application.version:dev}") String configuredVersion,
            @Value("${spring.application.name:badminton-vsb}") String configuredName
    ) {
        String buildVersion = buildProperties != null ? buildProperties.getVersion() : configuredVersion;
        String projectName = buildProperties != null ? buildProperties.getName() : configuredName;
